...
```powershell
python -m src.pipeline "https://icourse.fudan.edu.cn/livingroom?course_id=COURSE_ID&sub_id=SUB_ID&tenant_code=222"
```
...
```powershell
python -m src.pipeline "https://icourse.fudan.edu.cn/livingroom?course_id=COURSE_ID&sub_id=SUB_ID&tenant_code=222" --skip-cookies --skip-download --skip-transcribe
```
...
```powershell
python -m src.pipeline --course-id COURSE_ID --sub-id SUB_ID --skip-cookies --skip-download --skip-transcribe
```
...
```powershell
python -m src.pipeline --course-id COURSE_ID --sub-id SUB_ID --skip-transcribe
```
